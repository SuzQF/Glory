...
public class Factory_Archer: BaseBuildingObject, IEFactory {
    ...
    {
        //print("制造Archer完成");
        return Instantiate(archer, new Vector3(transform.position.x, transform.position.y - 1, 0), Quaternion.identity);
    }
